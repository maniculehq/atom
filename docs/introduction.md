...
| `generatePostMetadata` | Generates Next.js `Metadata` for a single post (title, description, Open Graph) |
...
- **Next.js 13+** with the App Router enabled (the SDK uses server components)
