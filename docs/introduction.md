...
In Atom, a **project** is a named container for your blog posts. Each project gets a unique **project key** — a Bearer token you use to identify which project's content to fetch. You copy that key from the dashboard and drop it into your Next.js app as an environment variable.
