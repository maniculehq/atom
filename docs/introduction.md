...
| `AtomLoadingSkeleton` | (none) | (none) | Placeholder skeleton shown while `AtomPage` streams. |
| `AtomArticleSkeleton` | (none) | (none) | Placeholder skeleton shown while `AtomPost` streams. |
